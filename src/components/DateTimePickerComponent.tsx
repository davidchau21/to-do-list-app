...
const DateTimePickerComponent = (props: Props) => {
  ...
  const [isVisibleModalDateTime, setIsVisibleDateTime] = useState(false);
  ...
  return (
    <>
      <View style={{marginBottom: 16}}>
        ...
        <RowComponent
          onPress={() => setIsVisibleDateTime(true)}
          styles={[
      ...
      <Modal visible={isVisibleModalDateTime} transparent animationType="slide">
        <View
          ...
          <View
            ...
            />
            <Button title="Close" onPress={() => setIsVisibleDateTime(false)} />
          </View>
        </View>
      </Modal>
    </>
